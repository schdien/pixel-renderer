Shader "Pixel Renderer/ScreenSpaceShadow"
{
	Subshader
	{
		ZTest off
		...
		Pass
		{
			...
			cbuffer DepthLightProperties {
				sampler2D _DepthTex;
				sampler2D _DirShadowAtlas;
			};
		...
		————————————————
				...
				原文链接：https ://blog.csdn.net/wodownload2/article/details/105202706
}
